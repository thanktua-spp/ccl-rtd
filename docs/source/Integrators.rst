...
Integrators::
   ...
   GaussLeg3::
      Description:  Computes the definite triple integral of a function over a region where the y-bounds are defined by a function and a constant, and the z-bounds are constants, using adaptive Gauss-Legendre quadrature.
