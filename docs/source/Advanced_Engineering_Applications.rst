...
Celestial mechanics is basically an interplay between Newton's law of gravitation :math: `F_i = \sum_{i noteq j} g\frac{m_i m_j}{||p_j - p_i||^2}d_ij` and Newton's second law of motion :math: `F_i = \frac{d}{dt}P_i`. 
