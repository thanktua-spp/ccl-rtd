...
=====
   Description: 
       Solves an ordinary differential equation (ODE) using the Dormand-Prince method (Ode45).
   Param: 
   ...
   Example: 
       ...
       .. code-block:: CSharp 
          ...
          SaveAs("Van der Pol-(mu = 1)-Ode45.png");

      Output: 

    .. figure:: images/Van der Pol-(mu = 1)-Ode45.png
       :align: center
